export const builtInThemes = {
  ...
  scholarly: {
    name: '书香墨韵',
    preview: {
      description: '作者开场的极简长文多图',
      features: ['头像作者', '大字号正文', '右下页码']
    },
    config: {
      title: {
        ...
        fontWeight: '800', color: '#1a1a1a', textAlign: 'left',
        marginBottom: '0'
      },
      content: {
        show: true, editable: true,
        ...
        color: '#000000', textAlign: 'left', lineHeight: '1.48', maxCharsPerLine: 22,
        backgroundColor: 'transparent', backdropFilter: 'none',
        padding: '0 0 34px', borderRadius: '0'
      },
      author: {
        show: true, editable: true, position: 'top-left',
        avatarSize: '58px', nicknameSize: '21px', nicknameColor: '#111111',
        usernameSize: '14px', usernameColor: '#555555',
        allowCustomAvatar: true, allowSocialIcon: true
      },
      time: {
        show: true, editable: true, position: 'bottom-left',
        format: 'MM/DD', fontSize: '18px', color: '#111111'
      },
      pageNumber: {
        show: true, editable: true, position: 'bottom-right',
        format: 'single', fontSize: '18px', color: '#111111'
      },
      watermark: {
        show: false, editable: false, position: 'none',
        text: '', fontSize: '0', color: 'transparent', opacity: 0
      },
      canvas: {
        ratio: '3:4',
        background: '#fbfbf7', padding: 48, borderRadius: 0, canvasScale: 80, bgType: 'light'
      },
      markdown: {
